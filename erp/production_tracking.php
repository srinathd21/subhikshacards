...
<div class="production-page">
    ...
    <div class="production-card production-header">
        ...
        <button type="button" class="production-btn" data-bs-toggle="modal" data-bs-target="#createJobModal">
            <i class="fa fa-plus me-1"></i> Create Job
        </button>
        <?php endif; ?>
    </div>
    ...
    <div class="production-card filter-card">
        <div class="stage-tabs">
            <a class="stage-tab <?= $stageFilter === 'all' ? 'active' : '' ?>" href="production_tracking.php">
                All
            </a>
                            ...
                            <div class="action-row">
                                ...
                                <form method="post" style="display:flex; gap:6px;">
                                    ...
                                    <select name="current_stage" class="stage-select">
                                        <?php foreach ($stages as $key => $label): ?>
                                        <option value="<?= e($key) ?>" <?= $jobStage === $key ? 'selected' : '' ?>>
                                            <?= e($label) ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
            ...
            <div class="modal-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="job_no" class="form-control" placeholder="JOB-001" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="item_name" class="form-control" placeholder="Wedding Invitation Card"
                            required>
                    </div>
